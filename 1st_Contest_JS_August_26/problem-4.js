...
function extractBodyContent(htmlString) {
    const startIndex = htmlString.indexOf('<body>') + '<body>'.length;
    const endIndex = htmlString.indexOf('</body>');
...
console.log(extractBodyContent(html1));
/* 
Output:
...
console.log(extractBodyContent(html2));
/* 
Output:
    <p>Hello world!</p>
    <div>
